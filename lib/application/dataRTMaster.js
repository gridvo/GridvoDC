            ...
            for (let rTDataKey of _.keys(dD.__rTDataMasterCenter__.stationRTDatas[stationRTDataKeys].rTDatas)) {
                rTdataFuns.push(function (cb) {
                    var sectionOptions = {
                        ...
                        dataName: rTDataKey,
                        startD: currentDate.setTime(-(dD.__rTDataMasterCenter__.stationRTDatas[stationRTDataKeys].rTDatas[rTDataKey].timeLong)),
                        endD: currentDate
                    };
...
DataRTMaster.prototype.StationRTDataIsOpen = function (stationName, callback) {
            ...
            for (let rTDataKey of _.keys(stationRTDataConfig.rTDataConfigs)) {
                rTdataFuns.push(function (cb) {
                    var sectionOptions = {
                        ...
                        dataName: rTDataKey,
                        startD: currentDate.setTime(-(dD.__rTDataMasterCenter__.stationRTDatas[stationName].rTDatas[rTDataKey].timeLong)),
                        endD: currentDate
                    };
                    dD.__dataRepository__.getDataSection(sectionOptions, cb);
                });
